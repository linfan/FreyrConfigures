...
;; 日出和日落的时间：
(setq calendar-latitude +104.06)
(setq calendar-longitude +30.67)
...
(setq local-holidays '((holiday-chinese 1 15  "元宵节 (正月十五)")
                       ...
                       ;; 生日
                       (holiday-fixed 7 20  "爸爸生日")
                       (holiday-fixed 10 9  "妈妈生日")
                       (holiday-fixed 10 20  "李晨生日")
                       (holiday-chinese 5 9 "李旭生日")   ;阴历生日
                       ))
